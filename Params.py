...
def parse_args():
    ...
    parser.add_argument('--uuedgeSampRate', default=0.1, type=float, help='Ratio of sampled social edges')
    ...
    parser.add_argument('--nodeDrop', default=0.9, type=float, help='rate for node dropout')
    parser.add_argument('--msgDrop', default=0.1, type=float, help='rate for message dropout')
